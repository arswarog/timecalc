        ...
        expect(ast).toEqual(
            new RootNode(
                new BinaryExpressionNode(
                    ...
                    new ValueNode({
                        integer: createToken(TokenType.NumericLiteral, '5', 0),
                    }),
                    new BracketedExpressionNode(
                        new BinaryExpressionNode(
                            createToken(TokenType.PlusOperation, '+', 7),
                            new ValueNode({
                                integer: createToken(TokenType.NumericLiteral, '12', 5),
                            }),
                            new ValueNode({
                                integer: createToken(TokenType.NumericLiteral, '34', 8),
                            }),
                        ),
            ...
            new RootNode(
                new BracketedExpressionNode(
                    new BinaryExpressionNode(
                        ...
                        new ValueNode({
                            integer: createToken(TokenType.NumericLiteral, '12', 2),
                        }),
                        new BracketedExpressionNode(
                            new BinaryExpressionNode(
                                createToken(TokenType.MultiplyOperation, '×', 8),
                                new ValueNode({
                                    integer: createToken(TokenType.NumericLiteral, '34', 6),
                                }),
                                new ValueNode({
                                    integer: createToken(TokenType.NumericLiteral, '5', 9),
                                }),
                            ),
                ...
                new BinaryExpressionNode(
                    ...
                    new BracketedExpressionNode(
                        new BinaryExpressionNode(
                            ...
                            new ValueNode({
                                integer: createToken(TokenType.NumericLiteral, '1', 3),
                            }),
                            new ValueNode({
                                integer: createToken(TokenType.NumericLiteral, '1', 7),
                            }),
                        ),
                        createToken(TokenType.OpeningBracket, '(', 1),
                    ...
                    new ValueNode({
                        integer: createToken(TokenType.NumericLiteral, '5', 13),
                    }),
                ),
                source,
            ),
